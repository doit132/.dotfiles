...
local core_map = {
	...
	["n|<C-S-s>"] = map_cu("wa"):with_noremap():with_silent():with_desc("edit: Save all file"),
	["n|Y"] = map_cmd("y$"):with_desc("edit: Yank text to EOL"),
	["n|ya"] = map_cmd("ggyG"):with_desc("edit: Yank all text"),
	["n|D"] = map_cmd("d$"):with_desc("edit: Delete text to EOL"),
	["n|da"] = map_cmd("ggdG"):with_desc("edit: Delete all text"),
	["n|n"] = map_cmd("nzzzv"):with_noremap():with_desc("edit: Next search result"),
	["n|N"] = map_cmd("Nzzzv"):with_noremap():with_desc("edit: Prev search result"),
	-- ["n|J"] = map_cmd("mzJ`z"):with_noremap():with_desc("edit: Join next line"),
	["n|J"] = map_cmd("9j"):with_noremap():with_desc("edit: jump next nine line"),
	["n|K"] = map_cmd("9k"):with_noremap():with_desc("edit: jump previous nine line"),
	["n|cc"] = map_cmd("<Cmd>setfiletype c<CR>"):with_noremap():with_desc("edit: Set filetype to cpp"),
	...
	-- undo
	["i|<C-z>"] = map_cmd("<ESC>ua"):with_silent():with_noremap():with_desc("edit: undo"),
	["i|<C-y>"] = map_cmd("<ESC><C-r>a"):with_silent():with_noremap():with_desc("edit: redo"),
	["n|<C-z>"] = map_cmd("<Nop>"):with_silent():with_noremap():with_desc("edit: nop"),
	["n|<C-y>"] = map_cmd("<Nop>"):with_silent():with_noremap():with_desc("edit: nop"),

	-- insert mode comment <C-/>
	["i|<C-_>"] = map_cmd("<ESC>gcca"):with_desc("edit: comment"),

	["n|<leader>cj"] = map_cmd("<C-w>j:q<CR>"):with_noremap():with_desc("window: Focus down and close"),
	["n|<leader>ck"] = map_cmd("<C-w>k:q<CR>"):with_noremap():with_desc("window: Focus up and close"),
	["n|<leader>ch"] = map_cmd("<C-w>h:q<CR>"):with_noremap():with_desc("window: Focus left and close"),
	["n|<leader>cl"] = map_cmd("<C-w>l:q<CR>"):with_noremap():with_desc("window: Focus right and close"),
	...
	["i|<C-s>"] = map_cmd("<Esc>:w<CR>"):with_noremap():with_desc("edit: Save file"),
	["i|<C-S-s>"] = map_cmd("<Esc>:wall<CR>"):with_noremap():with_desc("edit: Save all file"),
